...
def system_checker_page():
    ...
    if submit_button:
      ...
      # AI Disclaimer – always shown after results
    st.markdown("---")
    st.info(
        "⚠️ **Disclaimer:** These results are generated by an AI model and are **not 100% accurate**. "
        "This tool is intended for informational purposes only and does **not** replace professional medical advice. "
        "Please consult a doctor or healthcare provider for a definitive diagnosis and appropriate care."
    )
